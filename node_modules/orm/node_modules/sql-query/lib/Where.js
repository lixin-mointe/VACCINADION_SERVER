...
exports.build = function (Dialect, where, opts) {
	...
	/*console.log(" where------------- ----"+where.w);
	for (var i = 0; i < where.length; i++) {
		comsole.log("t="+where.w);
	}
	console.log(" where===================");*/
...
function buildOrGroup(Dialect, where, opts) {
	...
	for (var k in where.w) {
		...
		console.log("-----where.t="+where.t+" ---K="+k+"---where.w[k]="+where.w[k]+" sql_comparator="+where.w[k].sql_comparator);
		console.log(where.t );
   ...
   console.log("vvvvvvvvvvvvvvvvvvvv"+query.join(" AND "));
